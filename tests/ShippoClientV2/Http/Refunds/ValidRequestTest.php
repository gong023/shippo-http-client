...
class ValidRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        ShippoClientV2::mock()->add("refunds", 200, [
        ...
        $refund = ShippoClientV2::provider('dummy access token')->refunds()->create('dummy transaction object id');
    ...
    public function retrieveRefund()
    {
        ...
        ShippoClientV2::mock()->add("refunds/" . $dummyObjectId, 200, $mockObject);

        $refundResponse = ShippoClientV2::provider('dummy access token')->refunds()->retrieve($dummyObjectId);
    ...
    public function getRefundList()
    {
        ...
        $refund = ShippoClientV2::provider('dummy access token')->refunds()->getList();
